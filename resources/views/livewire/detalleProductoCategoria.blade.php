        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex mb-4">
                        <span class="flex items-center">
                            @for($i = 1; $i <= 5; $i++)
                                ...
                                @endif
                            @endfor
                            <span class="ml-3">{{ $product->reviews ?? 4 }} Reviews</span>
                        </span>
                    ...
                    <p class="leading-relaxed text-gray-300 dark:text-gray-300">
                    ...
                    <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-800 mb-5">
                        @if($product->color)
                        <div class="flex">
                            <span class="mr-3 text-gray-300">Color</span>
                            @php
                        ...
                        <div class="flex ml-6 items-center">
                            <span class="mr-3 text-gray-300">Talla</span>
                            <div class="relative">
                                <select class="rounded border border-gray-700 focus:ring-2 focus:ring-indigo-900 bg-transparent appearance-none py-2 focus:outline-none focus:border-indigo-500 text-black dark:text-white pl-3 pr-10">
                                    @php $tallas = explode(',', $product->talla); @endphp
                                    @foreach($tallas as $talla)
                                        <option class="text-black dark:text-black">{{ trim($talla) }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="flex items-center">
                        <span class="title-font font-medium text-2xl text-white dark:text-white">
                            ${{ number_format($product->precio ?? 0, 2) }}
                        </span>
                        <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded transition-colors">
                            Añadir al Carrito
                        </button>
                        <button class="rounded-full w-10 h-10 bg-gray-800 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4 hover:text-red-400 transition-colors">
                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5"
                                viewBox="0 0 24 24">
    ...
    <section class="text-gray-400 body-font relative z-10">
        <div class="container px-5 py-24 mx-auto">
            <div class="text-center mb-20">
                <h2 class="text-3xl font-medium title-font text-white dark:text-white mb-4">Productos Relacionados</h2>
                <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-300 dark:text-gray-300">
            ...
            <div class="flex flex-wrap -m-4">
                ...
                <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                    <a href="{{ route('detalleProductoCategoria', $relatedProduct->id) }}" class="block relative h-48 rounded overflow-hidden cursor-pointer group">
                    ...
                    <div class="mt-4">
                        <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">{{ $relatedProduct->categoria ?? 'SIN LÍMITE' }}</h3>
                        <h2 class="text-white dark:text-white title-font text-lg font-medium">{{ $relatedProduct->nombre }}</h2>
                        <p class="mt-1 text-indigo-400">${{ number_format($relatedProduct->precio, 2) }}</p>
                    </div>
                </div>
                @empty
                ...
                <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                    ...
                    <div class="mt-4">
                        <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">SIN LÍMITE</h3>
                        <h2 class="text-white dark:text-white title-font text-lg font-medium">Producto Ejemplo</h2>
                        <p class="mt-1 text-indigo-400">$16.00</p>
                    </div>
                </div>
                <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                    <a href="#" class="block relative h-48 rounded overflow-hidden cursor-pointer group">
                    ...
                    <div class="mt-4">
                        <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">SIN LÍMITE</h3>
                        <h2 class="text-white dark:text-white title-font text-lg font-medium">Producto Ejemplo</h2>
                        <p class="mt-1 text-indigo-400">$21.15</p>
                    </div>
                </div>
                <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                    <a href="#" class="block relative h-48 rounded overflow-hidden cursor-pointer group">
                    ...
                    <div class="mt-4">
                        <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">SIN LÍMITE</h3>
                        <h2 class="text-white dark:text-white title-font text-lg font-medium">Producto Ejemplo</h2>
                        <p class="mt-1 text-indigo-400">$12.00</p>
                    </div>
                </div>
                <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                    <a href="#" class="block relative h-48 rounded overflow-hidden cursor-pointer group">
                    ...
                    <div class="mt-4">
                        <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">SIN LÍMITE</h3>
                        <h2 class="text-white dark:text-white title-font text-lg font-medium">Producto Ejemplo</h2>
                        <p class="mt-1 text-indigo-400">$18.40</p>
                    </div>
                </div>
                @endforelse
            </div>
